  ...
  return (
    <div id="laporan-view" className="space-y-6">
      ...
      <div className="hidden print:block text-center border-b-2 border-double border-slate-800 pb-5 space-y-2 mb-6">
        <h1 className="text-xl font-bold uppercase tracking-tight text-slate-900">YAYASAN ALDIANA NUSANTARA</h1>
        <h2 className="text-2xl font-black uppercase tracking-tight text-slate-950">SMP, SMA, SMK YAYASAN ALDIANA NUSANTARA</h2>
        <p className="text-xs text-slate-500">Alamat: Jl. Siliwangi No. 1, Ciputat, Kota Tangerang Selatan, Email: info@aldiananusantara.sch.id</p>
        <div className="pt-2">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden print:shadow-none print:border-none">
          ...
          <div className="hidden print:block mt-12 grid grid-cols-2 gap-8 text-center text-xs break-inside-avoid">
            <div>
              <p>Mengetahui,</p>
              <p className="font-bold pt-1">Kepala Sekolah (SMP/SMA/SMK)</p>
